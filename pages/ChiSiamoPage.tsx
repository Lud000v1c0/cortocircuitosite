...
// 1. IMPORTA L'IMMAGINE QUI IN ALTO
// Assicurati che il percorso './volty.jpg' sia corretto rispetto a dove si trova questo file.
// Se l'immagine è nella stessa cartella di ChiSiamoPage.tsx, usa './volty.jpg'.
// Se è in src/assets, usa '../../assets/volty.jpg'.
import voltyImage from './volty.jpg'; 
        ...
        <div className="bg-black text-white min-h-screen overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row min-h-screen"> 
                ...
                <div className="md:w-2/5 w-full relative overflow-hidden h-96 md:h-auto animate-entrance">
                    <img 
                        // 2. USA LA VARIABILE IMPORTATA QUI (senza virgolette)
                        src={voltyImage}
                        alt="Volty"
